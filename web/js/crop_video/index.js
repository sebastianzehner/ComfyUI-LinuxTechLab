...
app.registerExtension({
  ...
  async beforeRegisterNodeDef(nodeType, nodeData) {
    ...
    nodeType.prototype.onNodeCreated = function () {
      ...
      muteBtn.style.cssText = `background:none;border:none;cursor:pointer;color:${C.blue};padding:0;line-height:1;display:flex;align-items:center;transition:color 0.15s;`;
      ...
      muteBtn.addEventListener("click", () => {
        ...
        video.muted = muteActive;
        muteBtn.style.color = muteActive ? C.red : C.blue;
        muteBtn.innerHTML = muteActive
