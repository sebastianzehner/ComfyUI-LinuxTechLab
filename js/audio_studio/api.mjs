...
const UPLOAD_ENDPOINT = "/linuxtechlab/api/audio_studio/upload";
 ...
 * @returns {Promise<{path: string}>} — relative path under input/linuxtechlab/
 */
 ...
 * under input/linuxtechlab/audio_studio/<id>/<kind>.<ext>, which /view can
...
export function getInlineSourceUrl(path) {
  ...
  const subfolder = ["linuxtechlab", ...parts].join("/");
  return (
